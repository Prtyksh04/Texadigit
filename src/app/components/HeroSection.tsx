...
const HeroSection: React.FC = () => {
    return (
        <section id="heroSectionBG" className="hero-equal-height relative">
            <Image
                    ...
                    <div className="lg:w-5/12 w-full mb-8 lg:mb-0">
                        <div className="text-black pt-4 lg:pl-32 flex flex-col items-center lg:block lg:text-white">
                            ...
                            <div className="action-btns mt-4 mr-2">
                                <Link
                                    href="/contact-us"
                                    className="btn secondary-solid-btn bg-pink-600 px-4 py-2 rounded hover:bg-pink-700 transition-colors duration-300"
                                >
                                    Get Started Now
                                </Link>
                            </div>
