...
const Footer: React.FC = () => {
  return (
    <footer className="footer-section">
      {/* Footer Top */}
      <div className="footer-top bg-gradient-to-r from-[#432E54] to-[#AE445A] px-4 md:px-8">
              ...
              <div className="flex flex-col md:flex-row">
                <div className="w-full md:w-1/3 p-4">
                  <div className="footer-nav-wrap text-white">
                    <Image
                      src="/images/png/Colorlogowithbackground.png"
                      alt="logo"
                      className="mb-2"
                      width={80}
                      height={16}
                ...
                <div className="w-full md:w-1/3 p-4">
                  <div className="footer-nav-wrap text-white">
                    ...
                    <ul className="nav flex flex-col gap-y-2 py-4">
                      ...
                      <li className="nav-item">
                        <a className="nav-link" href="/all-projects">Our Latest Projects</a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link" href="/all-services">About Our Services</a>
                      </li>
                      <li className="nav-item">
              ...
              <div className="footer-nav-wrap text-white">
                ...
                <ul className="flex flex-col gap-y-2 py-4">
                  {/* <li className="flex items-center py-2">
                    <span className="fas fa-map-marker-alt mr-2"></span>                             Addresss
          ...
          <div className="flex items-center justify-between">
            <div className="text-center md:text-left">
              <p className="copyright-text mb-0">
                ...
                <a href="http://www.texadigit.in/" target="_blank" rel="noopener noreferrer"> Imagine Digi</a>
              </p>
            </div>
