              ...
              <div className="flex flex-col md:flex-row">
                  ...
                  <div className="footer-nav-wrap text-white">
                    ...
                    <ul className="nav flex flex-col gap-y-2 py-4">
                      <li className="nav-item">
                        <a className="nav-link" href="/aboutus">About Imagine Digi</a>
                      </li>
                      <li className="nav-item">
                ...
                <div className="w-full md:w-1/3 p-4">
                  <div className="footer-nav-wrap text-white">
                    ...
                    <ul className="nav flex flex-col gap-y-2 py-4">
                      <li className="nav-item">
                        <a className="nav-link" href="/aboutus">Legal Information</a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link" href="/aboutus">Privacy Policy</a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link" href="/contactus">Report Abuse</a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link" href="/aboutus">Terms of Service</a>
                      </li>
                    </ul>
                  </div>
                </div>
