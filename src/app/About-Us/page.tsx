        ...
        <Navbar />
            ...
            <div className="flex flex-col md:flex-row justify-between items-start px-4 py-8 bg-white mt-8 gap-x-8">
                ...
                <div className="flex-1 md:ml-8">
                    <h1 className="text-4xl font-semibold text-gray-900">Texadigit</h1>
                    <p className="text-lg text-gray-600 mb-4">An IT Solution</p>

                    <div className="space-y-2">
                        <p><strong>Phone:</strong> +91-7733844020, +91-8619986762</p>
                        <p><strong>Email:</strong> support@texadigit.in</p>
                    </div>

                    <p className="text-gray-600 mt-4 text-xl">
                        <strong className="text-gray-600">TexaDigit</strong> is a youthful structure firm with a group of executives
